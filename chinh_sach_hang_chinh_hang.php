...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Chính sách hàng chính hãng | AWEB Computer Technology</title>
   ...
   <img src="img/chinh-sach-hang-chinh-hang.jpg" class="hnc-static-image" alt="Chính sách đảm bảo hàng chính hãng của AWEB">
   ...
   <p class="hnc-static-text"><strong>Chúng tôi cam kết</strong>, nếu sản phẩm có thông số kỹ thuật, mẫu mã, chất lượng không đúng với các thông số của hãng, của nhà sản xuất, chúng tôi sẽ hoàn trả lại 100% số tiền đã thanh toán cho quý khách trong thời hạn 3 ngày kể từ ngày khách hàng mua sản phẩm và còn giữ đầy đủ vỏ hộp, không trầy xước.</p>
