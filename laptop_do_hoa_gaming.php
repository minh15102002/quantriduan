...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Laptop đồ họa - gaming | AWEB Computer Technology</title>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="laptop_do_hoa_gaming.php" class="nav-item nav-link active">LAPTOP ĐỒ HỌA - GAMING</a>
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">LAPTOP ĐỒ HỌA - GAMING</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <?php 
                                ...
                                $laptop_do_hoa_gaming = mysqli_query($ket_noi, $sql);

                                while ($row = mysqli_fetch_array($laptop_do_hoa_gaming))
                                {
                            ;?>
