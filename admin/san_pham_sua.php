                              ...
                              ;?> 
                                <form method="POST" action="san_pham_sua_thuc_hien.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                     ...
                                     <div class="form-floating mb-3">
                                        <input class="form-control" id="txtAnhSanPham" name="txtAnhSanPham" type="file" placeholder="Ảnh sản phẩm"
                                        value="<?php echo $row['anhdaidien'] ;?>" />
                                        <label for="txtAnhSanPham">Ảnh sản phẩm</label>
                                     </div>
                                     <div class="form-floating mb-3">
                                        <input class="form-control" id="txtCauHinh" name="txtCauHinh" placeholder="Cấu hình" value="<?php echo $row['cauhinh'] ;?>" />
