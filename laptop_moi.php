...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Laptop mới | AWEB Computer Technology</title>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="laptop_moi.php" class="nav-item nav-link active">LAPTOP MỚI</a>
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">LAPTOP MỚI</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
